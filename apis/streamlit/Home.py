...
txt(
    "**Doctor of Philosophy** (Medical Technology), *Mahidol University*, Thailand",
    "2002-2006",
)
st.markdown(
    """
...
txt(
    "**Bachelors of Science** (Biological Science), *Mahidol University International College*, Thailand",
    "1998-2002",
)
st.markdown(
    """
...
txt(
    "**Co-Chair**, International Conference on Pharmaceutical Bioinformatics at Pattaya, Thailand",
    "2016",
)
st.markdown(
    """
...
txt(
    "**Content Creator**, [Data Professor YouTube Channel](https://youtube.com/dataprofessor/)",
    "2019-Present",
)
st.markdown(
    """
...
txt(
    "**Content Creator**, [Coding Professor YouTube Channel](https://youtube.com/codingprofessor/)",
    "2019-Present",
)
st.markdown(
    """
...
txt(
    "**Technical Writer**, [Data Professor Blog](https://data-professor.medium.com/) on Medium.com",
    "2019-Present",
)
st.markdown(
    """
...
txt4(
    "BioCurator",
    "A web server for curating ChEMBL bioactivity data",
    "http://codes.bio/biocurator/",
)
txt4(
    "CryoProtect",
    "A web server for classifying antifreeze proteins from non-antifreeze proteins",
    "http://codes.bio/cryoprotect/",
)
txt4(
    "ERpred",
    "A web server for the prediction of subtype-specific estrogen receptor antagonists",
    "http://codes.bio/erpred",
)
txt4(
    "HCVpred",
    "A web server for predicting the bioactivity of Hepatitis C virus NS5B inhibitors",
    "http://codes.bio/hemopred/",
)
txt4(
    "HemoPred",
    "A web server for predicting the hemolytic activity of peptides",
    "http://codes.bio/hemopred/",
)
txt4(
    "iQSP",
    "A sequence-based tool for the prediction and analysis of quorum sensing peptides",
    "http://codes.bio/iqsp/",
)
txt4(
    "Meta-iAVP",
    "A sequence-based meta-predictor for improving the prediction of antiviral peptides",
    "http://codes.bio/meta-iavp/",
)
txt4(
    "osFP",
    "A web server for predicting the oligomeric state of fluorescent proteins",
    "http://codes.bio/osfp/",
)
txt4(
    "PAAP",
    "A web server for predicting antihypertensive activity of peptides",
    "http://codes.bio/paap/",
)
txt4(
    "PepBio",
    "A web server for predicting the bioactivity of host defense peptide",
    "http://codes.bio/pepbio",
)
txt4(
    "PyBact",
    "Open source software written in Python for bacterial identification",
    "https://sourceforge.net/projects/pybact/",
)
txt4(
    "TargetAntiAngio",
    "A sequence-based tool for the prediction and analysis of anti-angiogenic peptides",
    "http://codes.bio/targetantiangio/",
)
txt4(
    "ThalPred",
    "Development of decision model for discriminating Thalassemia trait and Iron deficiency anemia",
    "http://codes.bio/thalpred/",
)
txt4(
    "THPep",
    "A web server for predicting tumor homing peptides",
    "http://codes.bio/thpep/",
)
